import { View, ScrollView, TextInput, StyleSheet, Text, Image, Modal, Pressable } from 'react-native';
...
export default function CardInputScreen({ selectedMethod }: ProfileProps) {
